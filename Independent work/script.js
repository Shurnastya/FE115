function delivery() {
    ...
    function showForm() {
        ...
        let nowDay  = new Date();
        today.value  = `${nowDay.getDate()} / ${nowDay.getMonth() + 1} / ${nowDay.getFullYear()}, ${nowDay.getHours()}:${nowDay.getMinutes()}:${nowDay.getSeconds()}`;
        ...
        let optionDestanation = createSelects(destinations);
        ...
        buttonCost.innerText = "Расчитать стоимость";
        ...
        form.append(h1, fio, phone, mail, typeDelivery, today, departure, destination, dateDeparture, dateDelivery, buttonCost);
